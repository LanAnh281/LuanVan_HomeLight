...
export default {
  ...
  setup(props, { emit }) {
    ...
    onMounted(async () => {
      $("#chatsupportModal").on("show.bs.modal", openModal); //lắng nghe mở modal
      $("#chatsupportModal").on("hidden.bs.modal", closeModal); //lắng nghe đóng modal
      await refresh();
    });
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title title" id="exampleModalLabel">Phản hồi</h5>
          <button
            type="button"
            class="close"
            data-dismiss="modal"
