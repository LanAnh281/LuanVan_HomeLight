...
export default {
  ...
  setup(props, { emit }) {
    ...
    onMounted(async () => {
      ...
      $("#viewRoomStatusModal").on("show.bs.modal", openModal); //lắng nghe mở modal
      $("#viewRoomStatusModal").on("hidden.bs.modal", closeModal); //lắng nghe đóng modal
    });
    return { data };
  },
};
